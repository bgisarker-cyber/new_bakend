...
"[project]/bgi-inverntory/src/app/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setError("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$bgi$2d$inverntory$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://127.0.0.1:8000/auth/login", data, {
                headers: {
...
_s(LoginPage, "vjDJgHZyAawolKflFHozYd8JoEo=", false, function() {
    return [
...
//# sourceMappingURL=bgi-inverntory_src_81edf103._.js.map