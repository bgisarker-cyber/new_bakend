...
/* ---------- dashboard card (UI upgraded) ---------- */ function DashboardCard(param) {
    let { title, onClick, icon: Icon } = param;
    if (!Icon) return null;
...
function HomePage() {
    ...
    const role = useRole();
    /* ---------- role-based buttons ---------- */ const buttons = __TURBOPACK__imported__module__$5b$project$5d2f$bgi$2d$inverntory$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
...
//# sourceMappingURL=bgi-inverntory_12872572._.js.map