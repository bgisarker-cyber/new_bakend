...
"[project]/bgi-inverntory/src/app/pubalibank/pubali-withdraw/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PubaliWithdrawPage = ()=>{
    ...
    const handleEditSave = async ()=>{
        ...
        try {
            ...
            alert("✅ Record S/N ".concat(editingRow["S/N"], " updated successfully!"));
            setEditingRow(null);
            await fetchRecords();
        } catch (err) {
            alert("❌ " + err.message);
...
//# sourceMappingURL=bgi-inverntory_src_app_pubalibank_pubali-withdraw_page_tsx_6bfa69af._.js.map